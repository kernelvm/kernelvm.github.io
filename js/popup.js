...
function popup1() {
    CreativaPopup.create('Feel free to DM me 150.230.107.212 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contacting" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">click to copy</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/tWmqFhNgeP" style="color: #ADD8E6;">https://discord.gg/tWmqFhNgeP</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("150.230.107.212");
    setTimeout(function() {
